...
-- Web Shops
insert into merchants(id, merchant_id, name, success_url, failed_url, error_url) values ('8ce8e7f3-5da0-4ace-8b52-af561e3aca79', '902a1e99-87e9-43b1-8927-9fbd4c2d9ca8', 'Products Shop', 'https://localhost:3000/success-transaction/', 'https://localhost:3000/failed-transaction/', 'https://localhost:3000/error-transaction/');
insert into merchants(id, merchant_id, name, success_url, failed_url, error_url) values ('1e3ba3a8-5369-4301-92fa-4b534c6b5144', '999c0c7c-aff3-41df-957d-d0677d43007b', 'Conferences Shop', 'https://localhost:3000/success-transaction/', 'https://localhost:3000/failed-transaction/', 'https://localhost:3000/error-transaction/');
insert into merchants(id, merchant_id, name, success_url, failed_url, error_url) values ('aa9b922c-0106-4316-9eff-e29b0ce63fc3', '4086f1d4-4002-4f1e-9bf8-ab0e82048584', 'Accommodations Shop', 'https://localhost:3000/success-transaction/', 'https://localhost:3000/failed-transaction/', 'https://localhost:3000/error-transaction/');
