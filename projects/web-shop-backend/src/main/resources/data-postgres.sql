...
-- 11aaAA@@
insert into users (id, password, full_name, email, address, phone, role, registered, web_shop_id, blocked) values ('45ebf110-23ff-4d94-aa47-c3a0f389ea3a', '$2y$10$qtwLWVTQMKSjFvIviXg9teAdxqIyR.QgAgNKwDPm7iQBepQcp9Ade', 'Products Admin', 'pa@mail.com', 'Cara Dusana 15', '0602236975', 0, true, '902a1e99-87e9-43b1-8927-9fbd4c2d9ca8', false);
insert into users (id, password, full_name, email, address, phone, role, registered, web_shop_id, blocked) values ('23891da2-0f5f-4f01-9e1a-01c1acc04094', '$2y$10$qtwLWVTQMKSjFvIviXg9teAdxqIyR.QgAgNKwDPm7iQBepQcp9Ade', 'Conferences Admin', 'ca@mail.com', 'Zmaj Jovina 20', '0606974458', 0, true, '999c0c7c-aff3-41df-957d-d0677d43007b', false);
insert into users (id, password, full_name, email, address, phone, role, registered, web_shop_id, blocked) values ('9f17eef5-af8e-40c5-8a6b-dad9da9374b5', '$2y$10$qtwLWVTQMKSjFvIviXg9teAdxqIyR.QgAgNKwDPm7iQBepQcp9Ade', 'Accommodations Admin', 'aa@mail.com', 'Josifa Runjanina 3', '0605498554', 0, true, '4086f1d4-4002-4f1e-9bf8-ab0e82048584', false);
insert into users (id, password, full_name, email, address, phone, role, registered, blocked) values ('1ee82676-4f9c-11ec-81d3-0242ac130003', '$2y$10$qtwLWVTQMKSjFvIviXg9teAdxqIyR.QgAgNKwDPm7iQBepQcp9Ade', 'Stefan Aradjanin', 'sa@mail.com', 'Cara Dusana 15', '0602236975', 1, true, false);
insert into users (id, password, full_name, email, address, phone, role, registered, blocked) values ('27037478-4f9c-11ec-81d3-0242ac130003', '$2y$10$qtwLWVTQMKSjFvIviXg9teAdxqIyR.QgAgNKwDPm7iQBepQcp9Ade', 'Stefan Savic', 'ss@mail.com', 'Zmaj Jovina 20', '0606974458', 1, true, false);
insert into users (id, password, full_name, email, address, phone, role, registered, blocked) values ('346f24f4-4f9c-11ec-81d3-0242ac130003', '$2y$10$qtwLWVTQMKSjFvIviXg9teAdxqIyR.QgAgNKwDPm7iQBepQcp9Ade', 'Stefan Beljic', 'sb@mail.com', 'Josifa Runjanina 3', '0605498554', 1, true, false);
