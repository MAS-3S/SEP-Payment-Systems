...
import PayPalMonthSubscription from "../pages/PayPalMonthSubscription";

export default function PayPalMonthSubscriptionContainer(props) {
  ...
  return loading ? null : sholudRedirect ? (
    ...
    <PayPalMonthSubscription payPalTransaction={payPalTransaction} />
  );
}
